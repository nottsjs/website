...
const Profile = ({ presenter }) => (
  <div className="row profile">
    <div className="col s12 m4 l3">
      <div className="row">
        <div className="col s8 offset-s2">
          <div className="avatar">
            <img src={presenter.img} alt={`${presenter.name} Picture`} className="circle responsive-img" />
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col s12 center-align">
          ...
          {presenter.url &&
            <a href="{{ .Params.presenter_url }}">
              <svg className="logo" viewBox="-2 -2 24 24">
    ...
    <div className="col s12 m8 l9">
      <h5 className="title">{presenter.name}</h5>
      {presenter.bio}
    </div>
  </div>
)
